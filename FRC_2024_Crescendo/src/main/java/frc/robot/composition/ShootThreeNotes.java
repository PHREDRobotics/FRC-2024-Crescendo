...
public class ShootThreeNotes extends SequentialCommandGroup {
     ...
     */
    public ShootThreeNotes(ArmSubsystem arm, IntakeSubsystem intake, ShooterSubsystem shoooter,
        ...
        addCommands(
                ...
                new ParallelCommandGroup(
                        new ShooterCommand(m_ShoooterSubsystem),
                        new OuttakeCommand(m_IntakeSubsystem)),
                //Goes to the third note and picks it up while holding the arm in the bottom position
                new ParallelDeadlineGroup(
                        new IntakeCommand(m_IntakeSubsystem),
                        new Pivot2d(swerve, 0, new Translation2d(0, 0)),
                        new ArmMoveToPositionCommand(ArmConstants.kArmPickup, arm)),
                //Goes back to the speaker and raises the arm
                new ParallelDeadlineGroup(
                        new Pivot2d(swerve, 0, new Translation2d(0, 0)),
                        new AutoResetArmEncoder(arm)),
                //Outtakes and shoots
